...
CREATE TABLE `budget` (
  ...
  PRIMARY KEY (`id`),
  KEY `budget_fin_idx` (`finance`),
  KEY `budget_fund_idx` (`funding`),
  KEY `budget_inter_idx` (`inter`),
  KEY `budget_object_idx` (`object`),
  KEY `measure_fk_idx` (`measure`),
  CONSTRAINT `measure_fk` FOREIGN KEY (`measure`) REFERENCES `measure` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `budget_val`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `budget_val` (
  ...
  PRIMARY KEY (`budget_id`,`year`),
  CONSTRAINT `budget_fk` FOREIGN KEY (`budget_id`) REFERENCES `budget` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `inter` (
  ...
  PRIMARY KEY (`id`),
  KEY `inter_type_idx` (`type`),
  CONSTRAINT `inter_type` FOREIGN KEY (`type`) REFERENCES `inter_types` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
DROP TABLE IF EXISTS `inter_types`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
CREATE TABLE `measure` (
  ...
  PRIMARY KEY (`id`),
  KEY `prio_measure_idx` (`prio_id`),
  CONSTRAINT `prio_measure` FOREIGN KEY (`prio_id`) REFERENCES `priority` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `prio_years`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `prio_years` (
  ...
  CONSTRAINT `user_fk` FOREIGN KEY (`user_id`) REFERENCES `budget_plan` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `priority` (
  ...
  PRIMARY KEY (`id`),
  KEY `prio_user_fk_idx` (`user_id`),
  CONSTRAINT `prio_user_fk` FOREIGN KEY (`user_id`) REFERENCES `budget_plan` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE
